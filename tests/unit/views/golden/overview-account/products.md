...
| Product | Next action | Clock | Capabilities | Kernels | Repositories | Last push |
|---|---|---|---|---|---|---|
| Alpha (`alpha`) | Write the first draft of the sync protocol | 52 days since 2026-08-01, **stale** | sync | Core (`core`), package | [`example-owner/alpha`](https://github.com/example-owner/alpha) | 2026-09-21 |
...
| Product | Status | Reason | Review by | Next action | Last push |
|---|---|---|---|---|---|
| Beta (`beta`) | paused | Waiting until alpha ships | 2026-09-01, **overdue** by 21 days | Sketch the sharing screen | 2026-09-19 |
