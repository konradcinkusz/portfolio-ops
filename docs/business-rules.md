...
| V3 | Overview: Markdown pages generated from the data, its history and the account scan, committed by the workflow to `overview/` in the private data repository, where GitHub renders them; never published to GitHub Pages (§7.11) | `overview` | — | 5 | planned | — |
